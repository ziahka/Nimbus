...
def rand(size: int, /) -> str:
    ...
    Uses `secrets` rather than `random`: the values this produces are used as
    inline callback data, unit ids and pending-command tokens, all of which are
    guessable if generated by a seedable PRNG.
